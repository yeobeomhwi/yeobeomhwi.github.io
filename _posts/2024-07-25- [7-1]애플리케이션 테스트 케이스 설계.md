...
| 분류 | 내용 | 
| --- | ---|
| <span style='background-color: #fff5b1'>**기능 테스트**</span><br>(Functional Test) | 주어진 <span style='background-color: #fff5b1'>**입력**</span>에 대해 기대되는 <span style='background-color: #fff5b1'>**출력**</span> 제공 여부를 테---
title: "SECTION 7-1 애플리케이션 테스트 케이스 설계"
date: "2024-07-25"
categories: [정보처리기사, SECTION _7]
tags:
